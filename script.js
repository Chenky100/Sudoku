...
// array with the id of every cell of the array
...
// return random full sudoku board
...
// remove a number from every array at a chosen row
...
// remove a number from every array at a chosen column
...
// remove a number from every array at a chosen box
...
// check if an array is a correct sudoku board
...
// duplicate a multi dimensional array
function dupArr(arr) {
...
// create an easy board and put it on the HTML
function easy(){
...
// create a medium board and put it on the HTML
...
// create a hard board and put it on the HTML
...
// disable the input that are allready filled
function disableIt() {
    let a = '';
    let b = '';
    let c = 0;
...
// clear all the numbers entered by the user 
function clearBoard() {
    for (let i = 0; i < 9 ; i++){
        for(let j = 0; j < 9; j++){            
...
// check if the board is finished and correct
function check() {
    for (let i = 0; i < 9 ; i++){
        for(let j = 0; j < 9; j++){ 
